sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.prototipo.controller.OrderList3", {
		...
		_onFioriListReportTableItemPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				this.doNavigate("PoDetail3_1", oBindingContext, fnResolve, "");
		...
		_onFioriListReportActionButtonPress2: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("CreateOrder3", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		onInit: function() {
			...
			this.oRouter.getTarget("OrderList3").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "Fiori_ListReport_ListReport_0-content-Fiori_ListReport_Table-1621541494494-s7wy1q1u8141a1li0tiq04a613_S13-qnfb1njw6s35spgdz36uqysb15_S15",
				"groups": ["items"]
			}];
