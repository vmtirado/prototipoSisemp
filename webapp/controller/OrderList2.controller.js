sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.prototipo.controller.OrderList2", {
		...
		_onFioriListReportTableItemPress: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				this.doNavigate("PoDetail2", oBindingContext, fnResolve, "");
		...
		onInit: function() {
			...
			this.oRouter.getTarget("OrderList2").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "Fiori_ListReport_ListReport_0-content-Fiori_ListReport_Table-1621541494494-s7wy1q1u8141a1li0tiq04a613_S13",
				"groups": ["items"]
			}];
